...
router.get('/upcoming', authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.get('/joinable', authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.get('/:id/can-join', authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.post('/auto-complete-past', authenticateToken, async (req: Request, res: Response) => {
  try {
    const now = new Date();
